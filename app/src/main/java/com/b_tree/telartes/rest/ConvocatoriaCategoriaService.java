 ...
 */
public abstract class ConvocatoriaCategoriaService  extends  ClasesRest{

    private List<Categoria> listaCategorias;

    public ConvocatoriaCategoriaService(Context context) {
        super(context);
    ...
    protected String getMetod() {
        // TODO Auto-generated method stub
        return "categoriaconvocatoriarest";
    }
    ...
    public void onSuccess(int i, Header[] headers, byte[] bytes) {
        try {
            ...
            for (int c = 0; c <jsonArray.length() ; c++) {
                listaCategorias.add(new Categoria(jsonArray.getJSONObject(c),"Convocatoria"));
            }
